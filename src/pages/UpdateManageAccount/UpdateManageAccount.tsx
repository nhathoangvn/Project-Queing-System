              ...
              <div className="create-account-form-item">
                <Row gutter={[24, 16]}>
                  <Col span={12}>
                    ...
                    <Input value="Nguyen Van A" className="form-item-input" />
                  </Col>
                  <Col span={12}>
                    <span className="label">
                      Tên đăng nhập: <span className="required">*</span>
                    </span>
                    <Input value="tuyetnguyen123" className="form-item-input" />
                  </Col>
                  <Col span={12}>
                    <span className="label">
                      Số điện thoại: <span className="required">*</span>
                    </span>
                    <Input value="09123456" className="form-item-input" />
                  </Col>
                  <Col span={12}>
                    <span className="label">
                  ...
                  <Col span={12}>
                    ...
                    <Input
                      value="tuyetnguyen123@gmail.com"
                      className="form-item-input"
                    />
                  </Col>
                  <Col span={12}>
